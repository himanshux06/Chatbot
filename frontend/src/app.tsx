        ...
        <div>
            {chatbotVisible && <div
                ...
                <div className="flex flex-col space-y-1.5 pb-6">
                    <h2 className="font-semibold text-lg tracking-tight mt-4">Ask questions about IAC</h2>
                    <p className="text-xs text-[#6b7280] leading-3">Industry-Academia Community is a part of 'Industry-Academia Connect' </p>
                    <p className="text-xs text-[#6b7280] leading-3">initiative of Cloud Counselage Pvt. Ltd.</p>
                </div>
                ...
                <div 
                    ...
                    <div className="flex gap-3 my-4 text-gray-600 text-sm flex-1">
                        ...
                        <p className="leading-relaxed">
                            <span className="block font-bold text-gray-700">AI </span> Hello !! How can I help you
                        </p>
                    </div>
                ...
                <div className="text-sm p-2 pl-0 pr-1 text-gray-500">
                        Example: Where to apply for the Internship?
                    </div>
                    ...
                    <div className="text-sm pt-3 pr-1 text-gray-500 text-center">
                        For more Information follow us on : <br></br>
                            <a href="https://www.whatsapp.com/channel/0029VaKRwJ6GOj9lRe7Jgw1p" className="p-2 text-blue-400">WhatsApp</a>
                            <a href="https://in.linkedin.com/company/cloud-counselage" className="p-2 text-blue-400">LinkdIn</a>
                            <a href="https://t.me/+uXmD1vTLpttjN2Vl" className="p-2 text-blue-400">Telegram</a>
                    </div>
                </div>

                <div 
                    className="absolute top-[10px] right-[10px] cursor-pointer mt-2"
